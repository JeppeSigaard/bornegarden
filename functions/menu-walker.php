...
/*
 * Adds value of new field to $item object that will be passed to     Walker_Nav_Menu_Edit_color
 */
...
add_filter( 'wp_edit_nav_menu_walker', 'color_nav_edit_walker',10,2 );
function color_nav_edit_walker($walker,$menu_id) {
    return 'Walker_Nav_Menu_Edit_color';
}
 ...
 */
class Walker_Nav_Menu_Edit_color extends Walker_Nav_Menu  {
/**
...
function start_el(&$output, $item, $depth = 0, $args = Array(), $id = 0) {
    ...
    <li id="menu-item-<?php echo $item_id; ?>" class="<?php echo implode(' ', $classes ); ?>">
        ...
        <div class="menu-item-settings" id="menu-item-settings-<?php echo $item_id; ?>">
            ...
            $smamo_color_options = array(
                '#a73636' => 'Mørkerød (standard)',
                '#6e6e39' => 'Mørkegrøn',
                '#a688a5' => 'Lilla',
                '#73a6b5' => 'Platinblå',
                '#9a9238' => 'Lysebrun',
            ...
            <p class="field-color description description-wide">
                <label for="edit-menu-item-color-<?php echo $item_id; ?>">
                    <?php _e( 'Farve' ); ?><br />
                    <select id="edit-menu-item-color-<?php echo $item_id; ?>" class="widefat code edit-menu-item-color" name="menu-item-color[<?php echo $item_id; ?>]">
                        <?php foreach($smamo_color_options as $key => $option) : ?>
                        <option value="<?php echo $key ?>" <?php if($key == $item->color){ echo 'selected'; } ?>><?php echo $option ?></option>
                        <?php endforeach; ?>
                    </select>
                </label>
            </p>
